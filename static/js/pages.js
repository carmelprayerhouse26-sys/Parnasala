...
async function renderHomePage() {
            ...
            <div>
                ...
                <section class="section" style="padding-top:0;">
                    <div class="container">
                        ...
                        <div class="featured-songs" id="featured-songs">${SkeletonCards(6)}</div>
                    </div>
                </section>
                ...
                <section class="section" style="padding-top:0;">
                    <div class="container">
                        ...
                        <div class="quick-nav">
                            <a href="#/songs"   class="quick-nav-card"><span class="material-icons-round">library_music</span><div class="quick-nav-card-title">${t('home_nav_allsongs')}</div></a>
                            <a href="#/about"   class="quick-nav-card"><span class="material-icons-round">church</span><div class="quick-nav-card-title">${t('home_nav_about')}</div></a>
                            <a href="#/contact" class="quick-nav-card"><span class="material-icons-round">call</span><div class="quick-nav-card-title">${t('home_nav_contact')}</div></a>
                            <a href="#/address" class="quick-nav-card"><span class="material-icons-round">location_on</span><div class="quick-nav-card-title">${t('home_nav_address')}</div></a>
                        </div>
                    </div>
                </section>
            </div>
    ...
    try {
        ...
        if (container) {
            container.innerHTML = songs.length > 0
                ? `<div class="songs-grid">${songs.slice(0, 6).map((s, i) => SongCard(s, i)).join('')}</div>`
                : EmptyState('music_off', t('songs_no_results'));
        }
        ...
        const c = $('#featured-songs');
        if (c) c.innerHTML = EmptyState('error', t('error_generic'));
    }
    ...
    if (recent.length > 0) {
        ...
        const rc = $('#recent-songs');
        if (rs) rs.style.display = '';
        if (rc) rc.innerHTML = recent.map(s => `
